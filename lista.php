...
// se a sessão id estiver vazia ou se a sessão estatus for diferente de adm entao execute
	...
	$consulta = $cn->query("SELECT * from tbl_filme");
...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<a href="frmAlterar.php?id=<?php echo $exibe['cod_filme'];?>&id2=<?php echo $exibe['cod_categoria'];?>&id3=<?php echo $exibe['cod_prod'];?>">
		...
		<a href="excluir.php?id=<?php echo $exibe['cod_filme']; ?>">	
